...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.be4tech.becare3.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.be4tech.becare3.repository.UserRepository.USERS_BY_EMAIL_CACHE);
