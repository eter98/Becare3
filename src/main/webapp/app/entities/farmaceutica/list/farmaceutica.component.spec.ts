...
import { FarmaceuticaComponent } from './farmaceutica.component';

describe('Component Tests', () => {
  describe('Farmaceutica Management Component', () => {
    let comp: FarmaceuticaComponent;
    let fixture: ComponentFixture<FarmaceuticaComponent>;
    let service: FarmaceuticaService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [FarmaceuticaComponent],
      })
        .overrideTemplate(FarmaceuticaComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(FarmaceuticaComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.farmaceuticas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
