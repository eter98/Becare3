...
describe('Component Tests', () => {
  describe('FrecuenciaCardiaca Management Component', () => {
    let comp: FrecuenciaCardiacaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [FrecuenciaCardiacaComponent],
      })
        .overrideTemplate(FrecuenciaCardiacaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.frecuenciaCardiacas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
