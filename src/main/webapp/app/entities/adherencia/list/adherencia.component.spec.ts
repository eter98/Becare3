...
describe('Component Tests', () => {
  describe('Adherencia Management Component', () => {
    let comp: AdherenciaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdherenciaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.adherencias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
