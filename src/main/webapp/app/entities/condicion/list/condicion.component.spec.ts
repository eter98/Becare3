...
describe('Component Tests', () => {
  describe('Condicion Management Component', () => {
    let comp: CondicionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CondicionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.condicions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
