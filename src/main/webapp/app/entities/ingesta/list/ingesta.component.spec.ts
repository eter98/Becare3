...
import { IngestaComponent } from './ingesta.component';

describe('Component Tests', () => {
  describe('Ingesta Management Component', () => {
    let comp: IngestaComponent;
    let fixture: ComponentFixture<IngestaComponent>;
    let service: IngestaService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [IngestaComponent],
      })
        .overrideTemplate(IngestaComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(IngestaComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ingestas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
